        ...
        {step === 1 ? (
          <div className="p-8">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl font-bold">Reserve Your Session</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select 
                  className="w-full bg-[#1a1d25] border border-white/10 rounded-xl px-4 py-3 text-sm focus:border-blue-500 outline-none"
              ...
              <button 
                type="submit" 
                className="w-full py-4 glossy-blue rounded-xl font-bold mt-6 shine-effect"
              >
                Confirm Booking
              </button>
            </form>
          ...
          <div className="p-12 text-center">
            ...
            <button 
              onClick={onClose}
              className="px-10 py-3 bg-white/5 hover:bg-white/10 rounded-xl font-bold transition-all"
            >
              Close Window
            </button>
          </div>
